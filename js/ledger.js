// ═══════════════════════════════════════════════════════════
// AK Chit Funds — MEMBER LEDGER - FULL CORRECTED VERSION
// ═══════════════════════════════════════════════════════════

/**
 * FIXED: Build due date list to resolve ReferenceError
 */
...
async function loadMemberLedger() {
    ...
    function buildSection(grp, enr, slotPays, slotNum, totalSlots, allDueDates, sectionId) {
        ...
        // CHIT/MO linked to Fixed Monthly Amount field from Firebase
